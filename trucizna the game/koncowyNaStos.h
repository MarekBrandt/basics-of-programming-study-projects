...
int main(int argc, int* argv[])
{
	...
	wczytajStanGryDoTalii(&liczbaGraczy, &liczbaKociolkow, talia, &ileKartWTalii, &maxKartWKotle, &aktywnyGracz);
	...
	//sprawdzPoprawnoscStanuGry(talia, ileKartWTalii, liczbaKociolkow, liczbaGraczy, maxKartWKotle, aktywnyGracz);
	//wypiszStol(talia, ileKartWTalii, aktywnyGracz, liczbaGraczy, liczbaKociolkow, maxKartWKotle);
...
//wypisuje liczby kart z calego stolu
//*****************************************************************************************************************************
void wypiszIleMaKtoKart(int ileKartWTalii, karta talia[], int liczbaGraczy, int liczbaKociolkow)
{
	for (int i = 0; i < liczbaGraczy; i++)
...
//zwraca liczbe kart  w zaleznosci od wejscia na rece , na decku , na stosie itd
//*****************************************************************************************************************************
int policzKarty(int ileKartWTalii, karta talia[], int ktoryGracz, int handOrDeckOrPile)
{
	int wynik = 0;
