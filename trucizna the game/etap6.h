...
void sprawdzPoprawnoscStanuGry(karta talia[], int liczbaKartWTalii, int liczbaKolorow, int liczbaGraczy, int maxWartoscKotla);
int sprawdzPoprawnoscIlosciKart(karta talia[], int liczbaKartWTalii, int liczbaGraczy);
void wczytajStanGryDoTalii(int* liczbaGraczy, int* liczbaKociolkow, karta talia[], int* ktoraKartaWTalii, int* maxKartWKotle);
void sprawdzPoprwnoscKociolki(karta talia[], int liczbaKartWTalii, int liczbaKociolkow, int maxWartoscKotla, int* ogolnyStan);
void poprawnoscKoloruWKociolku(karta talia[], int liczbaKartWTalii, int liczbaKociolkow, int* ogolnyStan);
void wartoscKociolka(karta talia[], int liczbaKartWTalii, int liczbaKociolkow, int maxWartoscKotla, int* ogolnyStan);
//************************************************************************
int main()
{
	int liczbaGraczy;
	...
	wczytajStanGryDoTalii(&liczbaGraczy, &liczbaKociolkow, talia, &ileKartWTalii, &maxKartWKotle);
	...
	//sprawdzPoprawnoscStanuGry(talia, ileKartWTalii, liczbaKociolkow, liczbaGraczy, maxKartWKotle);
...
void wczytajStanGryDoTalii(int* liczbaGraczy, int* liczbaKociolkow, karta talia[], int* ktoraKartaWTalii, int* maxKartWKotle)
{
	...
	*liczbaGraczy = znajdzLiczbe(wczytaneZdanie, 0); // wyluskuje liczbe graczy z tekstu
	...
	for (int i = 0; i < 2 * (*liczbaGraczy); i++)//wczytuje po lini dane, liczy ilosc kart i kolorow
	{
		...
		wczytajKartyDoTalii(wczytaneZdanie, talia, ktoraKartaWTalii, (i % 2) ? deck : hand, i + 1);
	}
...
void sprawdzPoprawnoscStanuGry(karta talia[], int liczbaKartWTalii, int liczbaKolorow, int liczbaGraczy, int maxWartoscKotla)
{
	...
	sprawdzPoprwnoscKociolki(talia, liczbaKartWTalii, liczbaKolorow, maxWartoscKotla, &ogolnyStan);
...
void sprawdzPoprwnoscKociolki(karta talia[], int liczbaKartWTalii, int liczbaKociolkow, int maxWartoscKotla, int* ogolnyStan)
{
	...
	wartoscKociolka(talia, liczbaKartWTalii, liczbaKociolkow, maxWartoscKotla, ogolnyStan);
}
//********************************************************************************************************************
void poprawnoscKoloruWKociolku(karta talia[], int liczbaKartWTalii, int liczbaKociolkow, int* ogolnyStan)
{
